...
public class ProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float rectRight = mProgress * (getWidth() - compoundPaddingRight - (getHeight() - compoundPaddingTop - compoundPaddingBottom));
        ...
        float fontLeft = getWidth() - compoundPaddingRight - (getHeight() - compoundPaddingTop - compoundPaddingBottom);
